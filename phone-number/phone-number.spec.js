...
describe("phoneNumberConverter", function () {
  ...
  it("phoneNumberConverter", function () {
  ...
  //phone number that is invalid (at least 2 separator/non-digit characters next to each other) should be replaced with 10 zeroes
  xit("phoneNumberConverter", function () {
